...
void addressMapping(uint64_t physicalAddress, unsigned &newTransactionChan, unsigned &newTransactionRank, unsigned &newTransactionBank, unsigned &newTransactionRow, unsigned &newTransactionColumn)
{
	...
	else if (addressMappingScheme == Scheme2)
	{
		...
		// std::cout<<"newTransactionRank = "<<newTransactionRank<<std::endl<<std::endl;;
		...
		// std::cout<<"tempA = "<<tempA<<std::endl;
		// std::cout<<"tempB = "<<tempB<<std::endl;
		// std::cout<<"bankBitWidth = "<<bankBitWidth<<std::endl;
		// std::cout<<"newTransactionBank = "<<newTransactionBank<<std::endl<<std::endl;
		...
		// std::cout<<"tempA = "<<tempA<<std::endl;
		// std::cout<<"tempB = "<<tempB<<std::endl;
		// std::cout<<"colHighBitWidth = "<<colHighBitWidth<<std::endl;
		// std::cout<<"newTransactionColumn = "<<newTransactionColumn<<std::endl<<std::endl;
		...
		// std::cout<<"tempA = "<<tempA<<std::endl;
		// std::cout<<"tempB = "<<tempB<<std::endl;
		// std::cout<<"rowBitWidth = "<<rowBitWidth<<std::endl;
		// std::cout<<"newTransactionRow = "<<newTransactionRow<<std::endl<<std::endl;
		...
		// std::cout<<"tempA = "<<tempA<<std::endl;
		// std::cout<<"tempB = "<<tempB<<std::endl;
		// std::cout<<"channelBitWidth = "<<channelBitWidth<<std::endl;
	...
	else if (addressMappingScheme == Scheme4)
	{
		...
		tempB = physicalAddress << channelBitWidth;
		newTransactionChan = tempA ^ tempB;
		// std::cout<<"colHighBitWidth = "<<colHighBitWidth<<", rowBitWidth = "<<rowBitWidth<<", bankBitWidth = "<<bankBitWidth<<", rankBitWidth = "<<rankBitWidth<<", channelBitWidth = "<<channelBitWidth<<std::endl;
